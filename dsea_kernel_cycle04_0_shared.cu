...
__global__ void dns_du1dxyz(int32_t i_worker, int32_t order_in, int32_t order_out, int32_t problemsize,
  ...
  /*order 0*/ double * __restrict__ Res_rhou1,
	...
	__shared__ double s_u1_ll[BLOCKSIZE_Y+4][BLOCKSIZE_Z+4]; // 4-wide halo
	__shared__ double s_u1_l[BLOCKSIZE_Y+4][BLOCKSIZE_Z+4]; // 4-wide halo
	__shared__ double s_u1_r[BLOCKSIZE_Y+4][BLOCKSIZE_Z+4]; // 4-wide halo
	__shared__ double s_u1_rr[BLOCKSIZE_Y+4][BLOCKSIZE_Z+4]; // 4-wide halo
...
__global__ void dns_du2dxyz(int32_t i_worker, int32_t order_in, int32_t order_out, int32_t problemsize,
	...
	__shared__ double s_u2_ll[BLOCKSIZE_Y+4][BLOCKSIZE_Z+4]; // 4-wide halo
	__shared__ double s_u2_l[BLOCKSIZE_Y+4][BLOCKSIZE_Z+4]; // 4-wide halo
	__shared__ double s_u2_r[BLOCKSIZE_Y+4][BLOCKSIZE_Z+4]; // 4-wide halo
	__shared__ double s_u2_rr[BLOCKSIZE_Y+4][BLOCKSIZE_Z+4]; // 4-wide halo
