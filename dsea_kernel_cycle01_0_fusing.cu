...
__global__ void dns_drhoETpdxyz(int32_t i_worker, int32_t order_in, int32_t order_out,
	...
	/*order 0*/ double * __restrict__ odrhou0u1dy,
	/*order 0*/ double * __restrict__ odrhou2u1dy,
	/*order 0*/ double * __restrict__ odrhou0u2dz,
	/*order 0*/ double * __restrict__ odrhou1u2dz,
	/*order 0*/ double * __restrict__ odrhou1u0dx,
	/*order 0*/ double * __restrict__ odrhou2u0dx) {
	// Thread Idx
	int32_t tidx = blockIdx.x*blockDim.x+threadIdx.x;
	// Global Idx
	int32_t gidx;
	...
	if (gidx<block_ncc) {
		...
		odrhou0u1dy[gidx] = dns_pDer1(rhou0_dy_ll * rhou1_dy_ll / rho_dy_ll, rhou0_dy_l * rhou1_dy_l / rho_dy_l, rhou0_dy_r * rhou1_dy_r / rho_dy_r, rhou0_dy_rr * rhou1_dy_rr / rho_dy_rr, DY);
		odrhou2u1dy[gidx] = dns_pDer1(rhou2_dy_ll * rhou1_dy_ll / rho_dy_ll, rhou2_dy_l * rhou1_dy_l / rho_dy_l, rhou2_dy_r * rhou1_dy_r / rho_dy_r, rhou2_dy_rr * rhou1_dy_rr / rho_dy_rr, DY);
		...
		odrhou0u2dz[gidx] = dns_pDer1(rhou0_dz_ll * rhou2_dz_ll / rho_dz_ll, rhou0_dz_l * rhou2_dz_l / rho_dz_l, rhou0_dz_r * rhou2_dz_r / rho_dz_r, rhou0_dz_rr * rhou2_dz_rr / rho_dz_rr, DZ);
		odrhou1u2dz[gidx] = dns_pDer1(rhou1_dz_ll * rhou2_dz_ll / rho_dz_ll, rhou1_dz_l * rhou2_dz_l / rho_dz_l, rhou1_dz_r * rhou2_dz_r / rho_dz_r, rhou1_dz_rr * rhou2_dz_rr / rho_dz_rr, DZ);
		...
		odrhou1u0dx[gidx] = dns_pDer1(rhou1_dx_ll * sy_bc_ll * rhou0_dx_ll / rho_dx_ll, 
		...
		odrhou2u0dx[gidx] = dns_pDer1(rhou2_dx_ll * sy_bc_ll * rhou0_dx_ll / rho_dx_ll, 
		...
		odTd2x[gidx] = dns_pDer2(calT(p_dx_ll, rho_dx_ll), calT(p_dx_l, rho_dx_l), calT(p_dx_c, rho_dx_c), calT(p_dx_r, rho_dx_r), calT(p_dx_rr, rho_dx_rr), DX);	
	}
