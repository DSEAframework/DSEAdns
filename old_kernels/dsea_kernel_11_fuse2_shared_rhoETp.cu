...
__device__ __forceinline__ double calT_ui(double irhoE, double irho, double u0, double u1, double u2) {
	double tmp = (irhoE  / irho - 0.5 * u0 * u0 - 0.5 * u1 * u1 - 0.5 * u2 * u2);
	tmp = (GAMA - 1) * tmp;
	return MINF * MINF * GAMA * tmp;
}
...
__global__ void dns_du0dxyz(int32_t i_worker, int32_t order_in, int32_t order_out, int32_t problemsize,
	...
	if (gidx<block_ncc) {
		...
		Res_rhou0[gidx] = -0.5 * dns_pDer1(sy_bc_ll * rhou0_dx_ll * sy_bc_ll * u0_dx_ll,
...
__global__ void dns_drhoETpdxyz(int32_t i_worker, int32_t order_in, int32_t order_out,
	...
	__shared__ double s_rhou1_c[BLOCKSIZE_Y+4][BLOCKSIZE_Z+4]; // 4-wide halo
	__shared__ double s_rhou2_c[BLOCKSIZE_Y+4][BLOCKSIZE_Z+4]; // 4-wide halo
	...
	if (gidx<block_ncc) {
		...
		s_rhou1_c[rb][cb] = irhou1_c[gidx];
		s_rhou2_c[rb][cb] = irhou2_c[gidx];
		...
		if (rb < 4) {
			...
			s_rhou0_c[rb-2][cb] = irhou0_c[dy_ll];
			s_rhou1_c[rb-2][cb] = irhou1_c[dy_ll];
			s_rhou2_c[rb-2][cb] = irhou2_c[dy_ll];
			s_rhoE_c[rb-2][cb] = irhoE_c[dy_ll];
		}
		if (rb >= BLOCKSIZE_Y) {
			IDX((NY+Y+2)%NY, Z, dy_rr, NZ);
			s_rho_c[rb+2][cb] = irho_c[dy_rr];
			s_rhou0_c[rb+2][cb] = irhou0_c[dy_rr];
			s_rhou1_c[rb+2][cb] = irhou1_c[dy_rr];
			s_rhou2_c[rb+2][cb] = irhou2_c[dy_rr];
		...
		if (cb < 4) {
			...
			s_rhou0_c[rb][cb-2] = irhou0_c[dz_ll];
			s_rhou1_c[rb][cb-2] = irhou1_c[dz_ll];
			s_rhou2_c[rb][cb-2] = irhou2_c[dz_ll];
			s_rhoE_c[rb][cb-2] = irhoE_c[dz_ll];
		}
		if (cb >= BLOCKSIZE_Z) {
			IDX(Y, (NZ+Z+2)%NZ, dz_rr, NZ);
			s_rho_c[rb][cb+2] = irho_c[dz_rr];
			s_rhou0_c[rb][cb+2] = irhou0_c[dz_rr];
			s_rhou1_c[rb][cb+2] = irhou1_c[dz_rr];
			s_rhou2_c[rb][cb+2] = irhou2_c[dz_rr];
		...
		double p_ll, p_l, p_c, p_r, p_rr;
		p_ll = calp(s_rhoE_c[rb-2][cb], s_rho_c[rb-2][cb], s_rhou0_c[rb-2][cb], s_rhou1_c[rb-2][cb], s_rhou2_c[rb-2][cb]);
		p_l = calp(s_rhoE_c[rb-1][cb], s_rho_c[rb-1][cb], s_rhou0_c[rb-1][cb], s_rhou1_c[rb-1][cb], s_rhou2_c[rb-1][cb]);
		p_r = calp(s_rhoE_c[rb+1][cb], s_rho_c[rb+1][cb], s_rhou0_c[rb+1][cb], s_rhou1_c[rb+1][cb], s_rhou2_c[rb+1][cb]);
		p_rr = calp(s_rhoE_c[rb+2][cb], s_rho_c[rb+2][cb], s_rhou0_c[rb+2][cb], s_rhou1_c[rb+2][cb], s_rhou2_c[rb+2][cb]);

		tmp_Res_rhou1 += -dns_pDer1(p_ll, p_l, p_r, p_rr, DY);
		tmp_Res_rhoE -= dns_pDer1(p_ll * s_rhou1_c[rb-2][cb] / s_rho_c[rb-2][cb], p_l * s_rhou1_c[rb-1][cb] / s_rho_c[rb-1][cb], p_r * s_rhou1_c[rb+1][cb] / s_rho_c[rb+1][cb], p_rr * s_rhou1_c[rb+2][cb] / s_rho_c[rb+2][cb], DY);
		
		p_c = calp(s_rhoE_c[rb][cb], s_rho_c[rb][cb], s_rhou0_c[rb][cb], s_rhou1_c[rb][cb], s_rhou2_c[rb][cb]);
		tmp_dTd2xi  += dns_pDer2(calT(p_ll, s_rho_c[rb-2][cb]), calT(p_l, s_rho_c[rb-1][cb]), calT(p_c, s_rho_c[rb][cb]), calT(p_r, s_rho_c[rb+1][cb]), calT(p_rr, s_rho_c[rb+2][cb]), DY);
		
		tmp_Res_rho += -0.5 * dns_pDer1(s_rho_c[rb-2][cb], s_rho_c[rb-1][cb], s_rho_c[rb+1][cb], s_rho_c[rb+2][cb], DY) * s_rhou1_c[rb][cb] / s_rho_c[rb][cb];
		
		tmp_Res_rhoE += -0.5 * dns_pDer1(s_rhoE_c[rb-2][cb], s_rhoE_c[rb-1][cb], s_rhoE_c[rb+1][cb], s_rhoE_c[rb+2][cb], DY) * s_rhou1_c[rb][cb] / s_rho_c[rb][cb];
		tmp_Res_rhoE += -0.5 * dns_pDer1(s_rhoE_c[rb-2][cb] * s_rhou1_c[rb-2][cb] / s_rho_c[rb-2][cb], s_rhoE_c[rb-1][cb] * s_rhou1_c[rb-1][cb] / s_rho_c[rb-1][cb], s_rhoE_c[rb+1][cb] * s_rhou1_c[rb+1][cb] / s_rho_c[rb+1][cb], s_rhoE_c[rb+2][cb] * s_rhou1_c[rb+2][cb] / s_rho_c[rb+2][cb], DY);
		
		tmp_Res_rhou0 += -0.5 * dns_pDer1(s_rhou0_c[rb-2][cb] * s_rhou1_c[rb-2][cb] / s_rho_c[rb-2][cb], s_rhou0_c[rb-1][cb] * s_rhou1_c[rb-1][cb] / s_rho_c[rb-1][cb], s_rhou0_c[rb+1][cb] * s_rhou1_c[rb+1][cb] / s_rho_c[rb+1][cb], s_rhou0_c[rb+2][cb] * s_rhou1_c[rb+2][cb] / s_rho_c[rb+2][cb], DY);
		tmp_Res_rhou2 += -0.5 * dns_pDer1(s_rhou2_c[rb-2][cb] * s_rhou1_c[rb-2][cb] / s_rho_c[rb-2][cb], s_rhou2_c[rb-1][cb] * s_rhou1_c[rb-1][cb] / s_rho_c[rb-1][cb], s_rhou2_c[rb+1][cb] * s_rhou1_c[rb+1][cb] / s_rho_c[rb+1][cb], s_rhou2_c[rb+2][cb] * s_rhou1_c[rb+2][cb] / s_rho_c[rb+2][cb], DY);

		p_ll = calp(s_rhoE_c[rb][cb-2], s_rho_c[rb][cb-2], s_rhou0_c[rb][cb-2], s_rhou1_c[rb][cb-2], s_rhou2_c[rb][cb-2]);
		p_l = calp(s_rhoE_c[rb][cb-1], s_rho_c[rb][cb-1], s_rhou0_c[rb][cb-1], s_rhou1_c[rb][cb-1], s_rhou2_c[rb][cb-1]);
		p_r = calp(s_rhoE_c[rb][cb+1], s_rho_c[rb][cb+1], s_rhou0_c[rb][cb+1], s_rhou1_c[rb][cb+1], s_rhou2_c[rb][cb+1]);
		p_rr = calp(s_rhoE_c[rb][cb+2], s_rho_c[rb][cb+2], s_rhou0_c[rb][cb+2], s_rhou1_c[rb][cb+2], s_rhou2_c[rb][cb+2]);
		tmp_Res_rhou2 += -dns_pDer1(p_ll, p_l, p_r, p_rr, DZ);

		tmp_Res_rhoE -= dns_pDer1(p_ll * s_rhou2_c[rb][cb-2] / s_rho_c[rb][cb-2], p_l * s_rhou2_c[rb][cb-1] / s_rho_c[rb][cb-1], p_r * s_rhou2_c[rb][cb+1] / s_rho_c[rb][cb+1], p_rr * s_rhou2_c[rb][cb+2] / s_rho_c[rb][cb+2], DZ);
		
		p_c = calp(s_rhoE_c[rb][cb], s_rho_c[rb][cb], s_rhou0_c[rb][cb], s_rhou1_c[rb][cb], s_rhou2_c[rb][cb]);
		tmp_dTd2xi  +=  dns_pDer2(calT(p_ll, s_rho_c[rb][cb-2]), calT(p_l, s_rho_c[rb][cb-1]), calT(p_c, s_rho_c[rb][cb]), calT(p_r, s_rho_c[rb][cb+1]), calT(p_rr, s_rho_c[rb][cb+2]), DZ);	

		tmp_Res_rho += -0.5 * dns_pDer1(s_rho_c[rb][cb-2], s_rho_c[rb][cb-1], s_rho_c[rb][cb+1], s_rho_c[rb][cb+2], DZ) * s_rhou2_c[rb][cb] / s_rho_c[rb][cb];
		
		tmp_Res_rhoE += -0.5 * dns_pDer1(s_rhoE_c[rb][cb-2], s_rhoE_c[rb][cb-1], s_rhoE_c[rb][cb+1], s_rhoE_c[rb][cb+2], DZ) * s_rhou2_c[rb][cb] / s_rho_c[rb][cb];
		
		tmp_Res_rhoE += -0.5 * dns_pDer1(s_rhoE_c[rb][cb-2] * s_rhou2_c[rb][cb-2] / s_rho_c[rb][cb-2], s_rhoE_c[rb][cb-1] * s_rhou2_c[rb][cb-1] / s_rho_c[rb][cb-1], s_rhoE_c[rb][cb+1] * s_rhou2_c[rb][cb+1] / s_rho_c[rb][cb+1], s_rhoE_c[rb][cb+2] * s_rhou2_c[rb][cb+2] / s_rho_c[rb][cb+2], DZ);
		
		tmp_Res_rhou0 += -0.5 * dns_pDer1(s_rhou0_c[rb][cb-2] * s_rhou2_c[rb][cb-2] / s_rho_c[rb][cb-2], s_rhou0_c[rb][cb-1] * s_rhou2_c[rb][cb-1] / s_rho_c[rb][cb-1], s_rhou0_c[rb][cb+1] * s_rhou2_c[rb][cb+1] / s_rho_c[rb][cb+1], s_rhou0_c[rb][cb+2] * s_rhou2_c[rb][cb+2] / s_rho_c[rb][cb+2], DZ);
		tmp_Res_rhou1 += -0.5 * dns_pDer1(s_rhou1_c[rb][cb-2] * s_rhou2_c[rb][cb-2] / s_rho_c[rb][cb-2], s_rhou1_c[rb][cb-1] * s_rhou2_c[rb][cb-1] / s_rho_c[rb][cb-1], s_rhou1_c[rb][cb+1] * s_rhou2_c[rb][cb+1] / s_rho_c[rb][cb+1], s_rhou1_c[rb][cb+2] * s_rhou2_c[rb][cb+2] / s_rho_c[rb][cb+2], DZ);
		...
		p_ll = calp(rhoE_dx_ll, rho_dx_ll, rhou0_dx_ll, rhou1_dx_ll, rhou2_dx_ll);
		p_l = calp(rhoE_dx_l, rho_dx_l, rhou0_dx_l, rhou1_dx_l, rhou2_dx_l);
		p_c = calp(rhoE_dx_c, rho_dx_c, rhou0_dx_c, rhou1_dx_c, rhou2_dx_c);
		p_r = calp(rhoE_dx_r, rho_dx_r, rhou0_dx_r, rhou1_dx_r, rhou2_dx_r);
		p_rr = calp(rhoE_dx_rr, rho_dx_rr, rhou0_dx_rr, rhou1_dx_rr, rhou2_dx_rr);

		tmp_Res_rho += -0.5 * dns_pDer1(rho_dx_ll, rho_dx_l, rho_dx_r, rho_dx_rr, DX) * rhou0_dx_c / rho_dx_c;
		
		tmp_Res_rhou0 += -dns_pDer1(p_ll, p_l, p_r, p_rr, DX);
		tmp_Res_rhoE -= dns_pDer1(p_ll * sy_bc_ll * rhou0_dx_ll / rho_dx_ll, 
												p_l * sy_bc_l * rhou0_dx_l / rho_dx_l, 
												p_r * sy_bc_r * rhou0_dx_r / rho_dx_r, 
												p_rr * sy_bc_rr * rhou0_dx_rr / rho_dx_rr, DX);
		...
		tmp_dTd2xi  +=  dns_pDer2(calT(p_ll, rho_dx_ll), calT(p_l, rho_dx_l), calT(p_c, rho_dx_c), calT(p_r, rho_dx_r), calT(p_rr, rho_dx_rr), DX);	
