...
__global__ void dns_drhoETpdx(int32_t i_worker, int32_t order_in, int32_t order_out,
	...
	if (gidx<block_ncc) {
		...
		double rho, invrho, rhou0, u0, u0_c, rhou1, rhou2, rhoE, p;
		double dTd2x;
		...
		tmp_Res_rho += -0.5 * fac_dk * fac_ll * rho * u0_c;
		tmp_Res_rhou0 += -fac_dk * fac_ll * p;
		tmp_Res_rhoE += -fac_dk * fac_ll * p * sy_bc_ll * u0;
		tmp_Res_rhoE += -0.5 * fac_dk * fac_ll * rhoE * u0_c;
		tmp_Res_rhoE += -0.5 * fac_dk * fac_ll * rhoE * sy_bc_ll * u0;
		tmp_Res_rhou1 += -0.5 * fac_dk * fac_ll * rhou1 * sy_bc_ll * u0;
		tmp_Res_rhou2 += -0.5 * fac_dk * fac_ll * rhou2 * sy_bc_ll * u0;
		...
		tmp_Res_rho += -0.5 * fac_dk * fac_l * rho * u0_c;
		tmp_Res_rhou0 += -fac_dk * fac_l * p;
		tmp_Res_rhoE += -fac_dk * fac_l* p * sy_bc_l * u0;
		tmp_Res_rhoE += -0.5 * fac_dk * fac_l * rhoE * u0_c;
		tmp_Res_rhoE += -0.5 * fac_dk * fac_l * rhoE * sy_bc_l * u0;;
		tmp_Res_rhou1 += -0.5 * fac_dk * fac_l * rhou1 * sy_bc_l * u0;
		tmp_Res_rhou2 += -0.5 * fac_dk * fac_l * rhou2 * sy_bc_l * u0;
		...
		tmp_Res_rho += -0.5 * fac_dk * fac_r * rho * u0_c;
		tmp_Res_rhou0 += -fac_dk * fac_r * p;
		tmp_Res_rhoE += -fac_dk * fac_r* p * sy_bc_r * u0;
		tmp_Res_rhoE += -0.5 * fac_dk * fac_r * rhoE * u0_c;
		tmp_Res_rhoE += -0.5 * fac_dk * fac_r * rhoE * sy_bc_r * u0;;
		tmp_Res_rhou1 += -0.5 * fac_dk * fac_r * rhou1 * sy_bc_r * u0;
		tmp_Res_rhou2 += -0.5 * fac_dk * fac_r * rhou2 * sy_bc_r * u0;
		...
		tmp_Res_rho += -0.5 * fac_dk * fac_rr * rho * u0_c;
		tmp_Res_rhou0 += -fac_dk * fac_rr * p;
		tmp_Res_rhoE += -fac_dk * fac_rr* p * sy_bc_rr * u0;
		tmp_Res_rhoE += -0.5 * fac_dk * fac_rr * rhoE * u0_c;
		tmp_Res_rhoE += -0.5 * fac_dk * fac_rr * rhoE * sy_bc_rr * u0;;
		tmp_Res_rhou1 += -0.5 * fac_dk * fac_rr * rhou1 * sy_bc_rr * u0;
		tmp_Res_rhou2 += -0.5 * fac_dk * fac_rr * rhou2 * sy_bc_rr * u0;
