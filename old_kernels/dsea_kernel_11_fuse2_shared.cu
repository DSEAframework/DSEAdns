...
__global__ void dns_du0dxyz(int32_t i_worker, int32_t order_in, int32_t order_out, int32_t problemsize,
	...
	if (gidx<block_ncc) {
		...
		if (rb < 4) {
			...
			s_rhou0_ll[rb-2][cb] = irhou0_ll[dy_ll];
			s_rhou0_l[rb-2][cb] = irhou0_l[dy_ll];
			s_rhou0_r[rb-2][cb] = irhou0_r[dy_ll];
			s_rhou0_rr[rb-2][cb] = irhou0_rr[dy_ll];
		...
		if (rb >= BLOCKSIZE_Y) {
			...
			s_rhou0_ll[rb+2][cb] = irhou0_ll[dy_rr];
			s_rhou0_l[rb+2][cb] = irhou0_l[dy_rr];
			s_rhou0_r[rb+2][cb] = irhou0_r[dy_rr];
			s_rhou0_rr[rb+2][cb] = irhou0_rr[dy_rr];
		...
		if (cb < 4) {
			...
			s_rhou0_ll[rb][cb-2] = irhou0_ll[dz_ll];
			s_rhou0_l[rb][cb-2] = irhou0_l[dz_ll];
			s_rhou0_r[rb][cb-2] = irhou0_r[dz_ll];
			s_rhou0_rr[rb][cb-2] = irhou0_rr[dz_ll];
		...
		if (cb >= BLOCKSIZE_Z) {
			...
			s_rhou0_ll[rb][cb+2] = irhou0_ll[dz_rr];
			s_rhou0_l[rb][cb+2] = irhou0_l[dz_rr];
			s_rhou0_r[rb][cb+2] = irhou0_r[dz_rr];
			s_rhou0_rr[rb][cb+2] = irhou0_rr[dz_rr];
